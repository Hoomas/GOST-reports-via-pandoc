...
function Table(el)
  ...
  -- endfoot нужен \hline, чтобы закрывать таблицу при переносе на след. страницу.
  -- endlastfoot — НЕ добавляем \hline: последняя строка тела уже ставит свой \hline
  -- через row_tex, иначе получим двойную линию снизу.
  table.insert(tex, "\\hline\n")
